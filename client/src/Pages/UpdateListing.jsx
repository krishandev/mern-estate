    ...
    const handleSubmit=async(e)=>{
         ...
         try {
            if(formData.imageUrls.length<1) return setError('You must upload atleat one Image')
                if(+formData.regularPrice<+formData.discountPrice) return setError('Discount price must me lower than Regular Price')
            setLoading(true);
            setError(false)
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className=' flex flex-col sm:flex-row gap-5' onSubmit={handleSubmit}>
            <div className=' flex flex-col gap-4 flex-1'>
                <input type='text' placeholder='Name' id='name' minLength='10' maxLength='62' required className=' border p-3 rounded-lg' onChange={handleChange} value={formData.name}/>
                <textarea type='text' placeholder='Description' id='description' minLength='10' maxLength='5000' required className=' border p-3 rounded-lg' onChange={handleChange} value={formData.description}/>
                <input type='text' placeholder='address' id='address' minLength='10' maxLength='62' required className=' border p-3 rounded-lg' onChange={handleChange} value={formData.address}/>
